...
## The Process
For our simulation, we will start with N=73500 'dust particles'. For every frame, will feed each particles' x and y coordinates into the following system of polynomials where $$|a_i|,|b_i| < 1\text{ for i }\in [1,N]$$:
